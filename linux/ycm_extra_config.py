...
BASE_FLAGS = [
    ...
    (HOME_DIRECTORY),
    '-isystem',
    '%s/.vim/bundle/YouCompleteMe/third_party/ycmd/cpp/llvm/include' %
    (HOME_DIRECTORY),
    '-isystem',
    '%s/.vim/bundle/YouCompleteMe/third_party/ycmd/cpp/llvm/include/clang-c' %
    (HOME_DIRECTORY),
    '-isystem',
    '%s/.vim/bundle/YouCompleteMe/third_party/ycmd/cpp/ClangCompleter' %
    (HOME_DIRECTORY),
    '-isystem',
    '%s/bazel-%s/external/eigen_archive/linux/include/eigen3/' %
    (WORK_PATH, PROJECT_NAME),
    '-isystem',
    '%s/bazel-%s/external/precompiled_pcl/include/' % (WORK_PATH,
                                                       PROJECT_NAME),
    '-isystem',
    '%s/bazel-%s/external/protobuf_git/src/' % (WORK_PATH, PROJECT_NAME),
    '-isystem',
    '%s/bazel-%s/external/precompiled_flann/linux/include/' % (WORK_PATH,
                                                               PROJECT_NAME),
    '-isystem',
    '%s/bazel-%s/external/gtest_git/googletest/include/' % (WORK_PATH,
                                                            PROJECT_NAME),
    '-isystem',
    '%s/bazel-%s/external/gtest_git/googlemock/include/' % (WORK_PATH,
                                                            PROJECT_NAME),
    '-isystem',
